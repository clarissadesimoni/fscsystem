...
file_dir: str = utils['desktop_file_dir'] if is_mac else os.path.join(pathlib.Path.home(), 'OneDrive', 'Desktop', 'syncthing', 'syncthing_dir', 'fscsystem_files') if is_windows else os.getcwd()
